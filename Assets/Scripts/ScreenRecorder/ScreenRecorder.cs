...
namespace Recorder
{
    public class ScreenRecorder : MonoBehaviour
    {
        ...
        private const string VIDEO_NAME = "Record", GALLERY_PATH = "/../../../../DCIM/NahualcalliAR";
        ...
        public void PrepareRecorder(string f)
        {
            filePath = f;
            #if UNITY_ANDROID && !UNITY_EDITOR
        ...
        private IEnumerator _SaveVideoToGallery()
        {
            ...
            System.IO.File.Copy(Application.persistentDataPath + "/" + VIDEO_NAME + ".mp4", filePath);
            ShowToast(GameObject.Find("Localization").GetComponent<Localization>().SearchWord("VIDEO_TOAST"));
            yield return null;
